...
var questions = [
    ...
    {
      title: "HTML program is saved using ____________ extension.",
      choices: [".hnl", ".htl", ".hmlt", ".html"],
      answer: ".html"
    },
    {
      title: "HTML was firstly proposed in year _______.",
      choices: [1999, 1990, 1982, 1985],
      answer: 1990
    },
    {
      title: "HTML tags are surrounded by __________ brackets.",
      choices: ["angle", "curly", "parentheses", "square"],
      answer: "angle"
    },
